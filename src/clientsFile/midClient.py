...
class MidClient(object):
    ...
    """
    def __init__(self, client_id, local_data, device, attack_type="label_flip", reputation=0):
    ...
    def set_repuation(self, new_rep):
    ...
    def client_update(self):
        ...
        # print(end - start)
        # print("it took the bad client to execute this number of epochs:", self.local_epoch)
